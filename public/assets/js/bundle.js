    ...
    value: function geraDigito(cpfSemDigito) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var StringNumerico = _step.value;
